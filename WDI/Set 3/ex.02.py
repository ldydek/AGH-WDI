...
# we change these elements from 1 to 2 not to 0, because later if we meet the same digit condition in line 13 could
# not be satisfied. This trick can help us solving the problem with only one auxiliary array.
