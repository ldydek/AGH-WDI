# 14. There are given two integers. We try to create the third one which consists of digits present in both integers.
...
def ex14(n1, n2, ctr=0, number=0):
    ctr1 = 0
    if n1 == 0 and n2 == 0 and prime(number):
        ctr1 += 1
    if n1 > 0:
        ctr1 += ex14(n1//10, n2, ctr+1, number+n1 % 10*10**ctr)
    if n2 > 0:
        ctr1 += ex14(n1, n2//10, ctr+1, number+n2 % 10*10**ctr)
    return ctr1
