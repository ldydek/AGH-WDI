# 27. Write a functions which merge two sorted linked lists into one sorted linked list. To these functions you should
...
def ex27_recur(A, B, J):
    ...
    if A.value < B.value:
        J.next = A
        J = J.next
        ex27_recur(A.next, B, J)
    else:
        J.next = B
        J = J.next
        ex27_recur(A, B.next, J)
